...
public class PoiUtil {
    ...
    public static void exportExcel(List<?> list, Class<?> pojoClass, HttpServletResponse response) throws IOException {
        defaultExport(list, pojoClass, null, response, new ExportParams(null, null, ExcelType.XSSF));
    }
    ...
    private static void downLoadExcel(String fileName, HttpServletResponse response, Workbook workbook)
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename="
                    + URLEncoder.encode((fileName == null ? new Date().getTime() : fileName) + "." + ExcelTypeEnum.XLSX.getValue(), "UTF-8"));
    ...
    public static void exportCsv(CsvExportParams params, Class<?> pojoClass,
        ...
        new CsvExportService(outputStream,params,pojoClass).write(dataSet);
    }
    ...
    public static void exportCsv(CsvExportParams params, List<ExcelExportEntity> entityList,
                                 Collection<?> dataSet, OutputStream outputStream) {
        new CsvExportService(outputStream,params,entityList).write(dataSet);
    }
